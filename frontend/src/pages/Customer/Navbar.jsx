...
const Navbar = () => {
    return (<header className="h-16 border-b border-gray-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-4 md:px-8 flex items-center justify-between sticky top-0 z-30 transition-colors duration-300">
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden sm:block">
          ...
          <input type="text" placeholder="Search policies, claims..." className="pl-10 pr-4 py-2 w-64 rounded-lg bg-gray-100 dark:bg-neutral-800 border-transparent focus:bg-white dark:focus:bg-neutral-700 focus:ring-2 focus:ring-indigo-500 outline-none text-sm transition-all"/>
        </div>
      </div>
