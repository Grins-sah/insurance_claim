...
import { FiPlus, FiSearch, FiCalendar, FiDollarSign, FiClock, FiCheckCircle, FiXCircle, FiFileText } from "react-icons/fi";
import DashboardLayout from "./DashboardLayout";

// --- Types (Necessary for TypeScript) ---
type ClaimStatus = "Under Review" | "Approved" | "Rejected" | "Pending Documents" | "Awaiting Payment";
  ...
  return (  
    <DashboardLayout>
      <div className="p-4 md:p-8">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-neutral-800 border-none rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 outline-none text-gray-900 dark:text-neutral-200"
            />
          </div>
        ...
        {claimsData.length === 0 && (
            <div className="mt-10 text-center py-10 border border-dashed border-gray-300 dark:border-neutral-700 rounded-xl">
