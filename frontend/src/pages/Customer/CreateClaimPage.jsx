...
const Step1PolicyDetails = ({ nextStep }) => (<div className="space-y-6">
    ...
    <div className="flex justify-end pt-4">
      <button onClick={nextStep} className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-xl font-medium transition shadow-md">
        Next: Documentation <FiChevronRight />
      </button>
    </div>
  </div>);
// --- STEP 2: Documentation and Evidence ---
const Step2Documentation = ({ nextStep, prevStep }) => (<div className="space-y-6">
    ...
    <div className="flex justify-between pt-4">
      <button onClick={prevStep} className="flex items-center gap-2 text-gray-600 dark:text-neutral-400 hover:text-gray-900 dark:hover:text-neutral-100 px-4 py-2.5 rounded-xl transition">
...
const Step3Review = ({ prevStep }) => {
    ...
    if (isSubmitted) {
        return (<div className="text-center py-16 px-6 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-xl">
                ...
                <button onClick={() => window.location.href = '/claims'} // Redirect to Claims History
    ...
    return (<div className="space-y-6">
            ...
            <div className="flex items-start pt-2">
                <input type="checkbox" id="declaration" className="mt-1 h-4 w-4 text-indigo-600 dark:bg-neutral-700 border-gray-300 rounded focus:ring-indigo-500" required/>
            ...
            <div className="flex justify-between pt-4">
                ...
                <button onClick={handleSubmit} className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-2.5 rounded-xl font-medium transition shadow-md">
