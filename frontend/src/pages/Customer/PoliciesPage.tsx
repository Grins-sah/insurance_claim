...
interface Policy {
  ...
  status: "Active" | "Expiring Soon" | "Lapsed";
}
      ...
      <div className="p-4 md:p-8">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative w-full md:w-96">
            ...
            <input 
              type="text" 
              placeholder="Search by policy ID or provider..." 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {policyData.map((policy) => (
            <div key={policy.id} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 group">
